public class A2App {
     ...
     */
    // Параметры методов !!!!!!!!!!!!!
    public static java.lang.String truncate(String text, int de) {
     ...
     * 
     */
    public static java.lang.String twosumm(Integer a, Integer b) {
        return "Summ=" + (a + b);
    }

    // Условная конструкция (if) №48
    // Мой вариант
    public static java.lang.String getSentenceTone(String sentence) {
    ...
    // Вариант учителя
    public static java.lang.String getSentenceTone1(String sentence) {
     ...
     * @return
     */
    public static java.lang.String whoIsThisHouseToStarks(String lastName) {
        var a = "Karstark";
        var b = "Tally";
        var c = "Lannister";
        var d = "Frey";
    ...
    // Решение учителя
    public static java.lang.String whoIsThisHouseToStarks1(String houseName) {
     ...
     * }
     * else {
     * return Character.isUpperCase(text.charAt(0)) ? text :
    ...
    public static java.lang.String getNumberExplanation(int number) {
        switch (number) {
            case 666:
                return "devil number";
            case 42:
    ...
    public static java.lang.String joinNumbersFromRange(int start, int finish) {
        var numbers = "";
        var i = start;
        while (i <= finish) {
            numbers = numbers + i;
    ...
    public static java.lang.String reverse(String str) {
    ...
    public static java.lang.String filterString(String str, char ch) {
        var i = 0;
    ...
    public static java.lang.String makeItFunny(String str, int n) {
        var i = 0;
        java.lang.String result = "";
        while (i < str.length()) {
    ...
    // Цикл For №62
    public static java.lang.String encrypt(String str) {
        // BEGIN
        var result = "";
